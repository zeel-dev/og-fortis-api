...
| `resource` | [`?string(ResourceEnum)`](../../doc/models/resource-enum.md) | Optional | Resource | getResource(): ?string | setResource(?string resource): void |
...
| `id` | `?string` | Optional | Signature ID<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getId(): ?string | setId(?string id): void |
