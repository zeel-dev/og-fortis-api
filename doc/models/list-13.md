...
| `terminalApplicationId` | `?string` | Optional | Terminal Application ID<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getTerminalApplicationId(): ?string | setTerminalApplicationId(?string terminalApplicationId): void |
...
| `title` | `?string` | Optional | Terminal Name<br>**Constraints**: *Maximum Length*: `24` | getTitle(): ?string | setTitle(?string title): void |
