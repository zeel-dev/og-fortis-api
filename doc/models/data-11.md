...
| `brandingDomain` | `?array` | Optional | Branding domain array | getBrandingDomain(): ?array | setBrandingDomain(?array brandingDomain): void |
| `productTransactions` | `?(array[])` | Optional | Product Transactions array | getProductTransactions(): ?array | setProductTransactions(?array productTransactions): void |
| `productFile` | `?array` | Optional | Product file array | getProductFile(): ?array | setProductFile(?array productFile): void |
| `productAccountvault` | `?array` | Optional | Product Token array | getProductAccountvault(): ?array | setProductAccountvault(?array productAccountvault): void |
| `productRecurring` | `?array` | Optional | Product recurring array | getProductRecurring(): ?array | setProductRecurring(?array productRecurring): void |
| `tags` | `?(array[])` | Optional | Tags array | getTags(): ?array | setTags(?array tags): void |
| `terminals` | `?(array[])` | Optional | Terminals array | getTerminals(): ?array | setTerminals(?array terminals): void |
