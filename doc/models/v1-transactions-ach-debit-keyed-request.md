...
| `accountType` | [`string(AccountType10Enum)`](../../doc/models/account-type-10-enum.md) | Required | Required for ACH transactions if account_vault_id is not provided.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `32` | getAccountType(): string | setAccountType(string accountType): void |
