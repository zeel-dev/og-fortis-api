...
|  --- | --- | --- | --- | --- | --- |
| `type` | [`?string(Type6Enum)`](../../doc/models/type-6-enum.md) | Optional | Resource Type<br>**Default**: `Type6Enum::CONTACTSEARCHSCOLLECTION` | getType(): ?string | setType(?string type): void |
