...
| `authRoleCode` | `?int` | Optional | Auth Role Code | getAuthRoleCode(): ?int | setAuthRoleCode(?int authRoleCode): void |
| `code` | `?int` | Optional | Auth Role User Code | getCode(): ?int | setCode(?int code): void |
