...
| `authCode` | `string` | Required | Required on force transactions. Ignored for all other actions.<br>**Constraints**: *Maximum Length*: `6` | getAuthCode(): string | setAuthCode(string authCode): void |
