...
| `itemList` | [`?(ItemList[])`](../../doc/models/item-list.md) | Optional | Item List<br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `99`, *Unique Items Required* | getItemList(): ?array | setItemList(?array itemList): void |
