...
| `accountNumber` | string\|null | Optional | This is a container for any-of cases. | getAccountNumber(): ?string | setAccountNumber(?string accountNumber): void |
...
| `expDate` | string\|null | Optional | This is a container for any-of cases. | getExpDate(): ?string | setExpDate(?string expDate): void |
