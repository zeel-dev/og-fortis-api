...
| `body` | `?string` | Optional | Body<br>**Constraints**: *Maximum Length*: `65000` | getBody(): ?string | setBody(?string body): void |
| `title` | `?string` | Optional | Title<br>**Constraints**: *Maximum Length*: `255` | getTitle(): ?string | setTitle(?string title): void |
| `id` | `?string` | Optional | Help Page ID<br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` | getId(): ?string | setId(?string id): void |
