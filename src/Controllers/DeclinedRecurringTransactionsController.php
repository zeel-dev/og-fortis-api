...
class DeclinedRecurringTransactionsController extends BaseController
{
    /**
     * @param string $declinedRecurringTransactionId Id
     ...
     */
    public function getOneDeclinedRecurringTransaction(
        ...
        $_reqBuilder = $this->requestBuilder(
            ...
            ->parameters(
                TemplateParam::init('declined_recurring_transaction_id', $declinedRecurringTransactionId),
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ResponseDeclinedRecurringTransaction::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function listAllDeclinedRecurringTransactions(
        ?Page $page = null,
        ?array $order = null,
        ?array $filterBy = null,
        ?array $expand = null,
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v1/declined-recurring-transactions')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(
        ...
        $_resHandler = $this->responseHandler()
            ->throwErrorOn('401', ErrorType::init('Unauthorized', Response401tokenException::class))
            ->type(ResponseDeclinedRecurringTransactionsCollection::class);

        return $this->execute($_reqBuilder, $_resHandler);
    }

    /**
     * @param V1DeclinedRecurringTransactionPaymentsRequest $body
     *
     * @return ResponseDeclinedRecurringTransactionPayment Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function createAPayment(
        V1DeclinedRecurringTransactionPaymentsRequest $body
    ): ResponseDeclinedRecurringTransactionPayment {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v1/declined-recurring-transaction-payments')
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
        ...
        $_resHandler = $this->responseHandler()
            ...
            ->type(ResponseDeclinedRecurringTransactionPayment::class);
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function rerunTheTransaction(
        string $declinedRecurringTransactionId,
        ?array $expand = null
    ): ResponseDeclinedRecurringTransaction {
        $_reqBuilder = $this->requestBuilder(
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function resendTheTransaction(
        string $declinedRecurringTransactionId
        ...
        $_reqBuilder = $this->requestBuilder(
            ...
            ->auth(Auth::and('user-id', 'user-api-key', 'developer-id'))
            ->parameters(TemplateParam::init('declined_recurring_transaction_id', $declinedRecurringTransactionId));

        $_resHandler = $this->responseHandler()
            ->throwErrorOn('401', ErrorType::init('Unauthorized', Response401tokenException::class))
            ->type(ResponseDeclinedRecurringTransactionResend::class);
