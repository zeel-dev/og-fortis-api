...
/**
 * Builder for model V1TransactionsCashSaleRequest
 *
 * @see V1TransactionsCashSaleRequest
 */
class V1TransactionsCashSaleRequestBuilder
{
    /**
     * @var V1TransactionsCashSaleRequest
     */
    private $instance;

    private function __construct(V1TransactionsCashSaleRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cash sale request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsCashSaleRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions cash sale request object.
     */
    public function build(): V1TransactionsCashSaleRequest
    {
