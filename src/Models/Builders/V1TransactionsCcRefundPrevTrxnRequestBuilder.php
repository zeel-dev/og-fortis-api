...
/**
 * Builder for model V1TransactionsCcRefundPrevTrxnRequest
 *
 * @see V1TransactionsCcRefundPrevTrxnRequest
 */
class V1TransactionsCcRefundPrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundPrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundPrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund prev trxn request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcRefundPrevTrxnRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund prev trxn request object.
     */
    public function build(): V1TransactionsCcRefundPrevTrxnRequest
    {
