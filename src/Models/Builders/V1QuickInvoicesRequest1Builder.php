...
/**
 * Builder for model V1QuickInvoicesRequest1
 *
 * @see V1QuickInvoicesRequest1
 */
class V1QuickInvoicesRequest1Builder
{
    /**
     * @var V1QuickInvoicesRequest1
     */
    private $instance;

    private function __construct(V1QuickInvoicesRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 quick invoices request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1QuickInvoicesRequest1());
    }
    ...
    /**
     * Unsets bank funded only override field.
     */
    public function unsetBankFundedOnlyOverride(): self
    {
        $this->instance->unsetBankFundedOnlyOverride();
        return $this;
    }
    ...
    /**
     * Initializes a new v1 quick invoices request 1 object.
     */
    public function build(): V1QuickInvoicesRequest1
    {
