...
/**
 * Builder for model V1TokensWalletRequest
 *
 * @see V1TokensWalletRequest
 */
class V1TokensWalletRequestBuilder
{
    /**
     * @var V1TokensWalletRequest
     */
    private $instance;

    private function __construct(V1TokensWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 tokens wallet request Builder object.
     */
    public static function init(string $locationId, string $walletData, string $walletProvider): self
    {
        return new self(new V1TokensWalletRequest($locationId, $walletData, $walletProvider));
    }
    ...
    /**
     * Initializes a new v1 tokens wallet request object.
     */
    public function build(): V1TokensWalletRequest
    {
