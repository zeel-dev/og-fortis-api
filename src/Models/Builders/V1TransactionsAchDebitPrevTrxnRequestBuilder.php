...
/**
 * Builder for model V1TransactionsAchDebitPrevTrxnRequest
 *
 * @see V1TransactionsAchDebitPrevTrxnRequest
 */
class V1TransactionsAchDebitPrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsAchDebitPrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsAchDebitPrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions ach debit prev trxn request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsAchDebitPrevTrxnRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions ach debit prev trxn request object.
     */
    public function build(): V1TransactionsAchDebitPrevTrxnRequest
    {
