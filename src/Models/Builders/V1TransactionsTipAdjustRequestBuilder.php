...
/**
 * Builder for model V1TransactionsTipAdjustRequest
 *
 * @see V1TransactionsTipAdjustRequest
 */
class V1TransactionsTipAdjustRequestBuilder
{
    /**
     * @var V1TransactionsTipAdjustRequest
     */
    private $instance;

    private function __construct(V1TransactionsTipAdjustRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions tip adjust request Builder object.
     */
    public static function init(int $tipAmount, int $transactionAmount): self
    {
        return new self(new V1TransactionsTipAdjustRequest($tipAmount, $transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions tip adjust request object.
     */
    public function build(): V1TransactionsTipAdjustRequest
    {
