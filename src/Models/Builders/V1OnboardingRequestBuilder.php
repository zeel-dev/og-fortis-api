...
use FortisAPILib\Models\Location20;
use FortisAPILib\Models\PrimaryPrincipal1;
use FortisAPILib\Models\V1OnboardingRequest;

/**
 * Builder for model V1OnboardingRequest
 *
 * @see V1OnboardingRequest
 */
class V1OnboardingRequestBuilder
{
    /**
     * @var V1OnboardingRequest
     */
    private $instance;

    private function __construct(V1OnboardingRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 onboarding request Builder object.
     */
    public static function init(
        ...
        return new self(new V1OnboardingRequest(
            $primaryPrincipal,
            $templateCode,
            $email,
            $dbaName,
    ...
    /**
     * Initializes a new v1 onboarding request object.
     */
    public function build(): V1OnboardingRequest
    {
