...
use FortisAPILib\Models\AccountVaultCauProductTransaction;
use FortisAPILib\Models\Address1;

/**
 * Builder for model AccountVaultCauProductTransaction
 *
 * @see AccountVaultCauProductTransaction
 */
class AccountVaultCauProductTransactionBuilder
{
    /**
     * @var AccountVaultCauProductTransaction
     */
    private $instance;

    private function __construct(AccountVaultCauProductTransaction $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new account vault cau product transaction Builder object.
     */
    public static function init(): self
    {
        return new self(new AccountVaultCauProductTransaction());
    }
    ...
    /**
     * Initializes a new account vault cau product transaction object.
     */
    public function build(): AccountVaultCauProductTransaction
    {
