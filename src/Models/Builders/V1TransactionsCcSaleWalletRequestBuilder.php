...
/**
 * Builder for model V1TransactionsCcSaleWalletRequest
 *
 * @see V1TransactionsCcSaleWalletRequest
 */
class V1TransactionsCcSaleWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale wallet request Builder object.
     */
    public static function init(int $transactionAmount, string $walletData, string $walletProvider): self
    {
        return new self(new V1TransactionsCcSaleWalletRequest($transactionAmount, $walletData, $walletProvider));
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale wallet request object.
     */
    public function build(): V1TransactionsCcSaleWalletRequest
    {
