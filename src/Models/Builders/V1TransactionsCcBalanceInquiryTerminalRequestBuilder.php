...
/**
 * Builder for model V1TransactionsCcBalanceInquiryTerminalRequest
 *
 * @see V1TransactionsCcBalanceInquiryTerminalRequest
 */
class V1TransactionsCcBalanceInquiryTerminalRequestBuilder
{
    /**
     * @var V1TransactionsCcBalanceInquiryTerminalRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcBalanceInquiryTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc balance inquiry terminal request Builder object.
     */
    public static function init(string $locationId, string $terminalId): self
    {
        return new self(new V1TransactionsCcBalanceInquiryTerminalRequest($locationId, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc balance inquiry terminal request object.
     */
    public function build(): V1TransactionsCcBalanceInquiryTerminalRequest
    {
