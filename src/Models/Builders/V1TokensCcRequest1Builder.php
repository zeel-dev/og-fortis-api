...
/**
 * Builder for model V1TokensCcRequest1
 *
 * @see V1TokensCcRequest1
 */
class V1TokensCcRequest1Builder
{
    /**
     * @var V1TokensCcRequest1
     */
    private $instance;

    private function __construct(V1TokensCcRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 tokens cc request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TokensCcRequest1());
    }
    ...
    /**
     * Initializes a new v1 tokens cc request 1 object.
     */
    public function build(): V1TokensCcRequest1
    {
