...
/**
 * Builder for model V1TransactionsAchCreditKeyedRequest
 *
 * @see V1TransactionsAchCreditKeyedRequest
 */
class V1TransactionsAchCreditKeyedRequestBuilder
{
    /**
     * @var V1TransactionsAchCreditKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsAchCreditKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions ach credit keyed request Builder object.
     */
    public static function init(
        ...
        return new self(new V1TransactionsAchCreditKeyedRequest(
            $transactionAmount,
            $accountHolderName,
            $accountNumber,
            $accountType,
    ...
    /**
     * Initializes a new v1 transactions ach credit keyed request object.
     */
    public function build(): V1TransactionsAchCreditKeyedRequest
    {
