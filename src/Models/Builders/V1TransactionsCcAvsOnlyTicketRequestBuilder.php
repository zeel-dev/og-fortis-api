...
/**
 * Builder for model V1TransactionsCcAvsOnlyTicketRequest
 *
 * @see V1TransactionsCcAvsOnlyTicketRequest
 */
class V1TransactionsCcAvsOnlyTicketRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyTicketRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyTicketRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only ticket request Builder object.
     */
    public static function init(string $ticketId): self
    {
        return new self(new V1TransactionsCcAvsOnlyTicketRequest($ticketId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only ticket request object.
     */
    public function build(): V1TransactionsCcAvsOnlyTicketRequest
    {
