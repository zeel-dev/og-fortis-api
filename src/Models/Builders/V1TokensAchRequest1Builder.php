...
/**
 * Builder for model V1TokensAchRequest1
 *
 * @see V1TokensAchRequest1
 */
class V1TokensAchRequest1Builder
{
    /**
     * @var V1TokensAchRequest1
     */
    private $instance;

    private function __construct(V1TokensAchRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 tokens ach request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TokensAchRequest1());
    }
    ...
    /**
     * Initializes a new v1 tokens ach request 1 object.
     */
    public function build(): V1TokensAchRequest1
    {
