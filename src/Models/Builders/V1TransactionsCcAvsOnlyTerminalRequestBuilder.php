...
/**
 * Builder for model V1TransactionsCcAvsOnlyTerminalRequest
 *
 * @see V1TransactionsCcAvsOnlyTerminalRequest
 */
class V1TransactionsCcAvsOnlyTerminalRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyTerminalRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only terminal request Builder object.
     */
    public static function init(string $locationId, string $terminalId): self
    {
        return new self(new V1TransactionsCcAvsOnlyTerminalRequest($locationId, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only terminal request object.
     */
    public function build(): V1TransactionsCcAvsOnlyTerminalRequest
    {
