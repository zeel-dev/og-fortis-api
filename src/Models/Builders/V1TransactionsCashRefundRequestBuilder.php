...
/**
 * Builder for model V1TransactionsCashRefundRequest
 *
 * @see V1TransactionsCashRefundRequest
 */
class V1TransactionsCashRefundRequestBuilder
{
    /**
     * @var V1TransactionsCashRefundRequest
     */
    private $instance;

    private function __construct(V1TransactionsCashRefundRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cash refund request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsCashRefundRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions cash refund request object.
     */
    public function build(): V1TransactionsCashRefundRequest
    {
