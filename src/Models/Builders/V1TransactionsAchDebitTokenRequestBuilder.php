...
/**
 * Builder for model V1TransactionsAchDebitTokenRequest
 *
 * @see V1TransactionsAchDebitTokenRequest
 */
class V1TransactionsAchDebitTokenRequestBuilder
{
    /**
     * @var V1TransactionsAchDebitTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsAchDebitTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions ach debit token request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsAchDebitTokenRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions ach debit token request object.
     */
    public function build(): V1TransactionsAchDebitTokenRequest
    {
