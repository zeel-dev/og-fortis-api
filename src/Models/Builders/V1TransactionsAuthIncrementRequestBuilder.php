...
/**
 * Builder for model V1TransactionsAuthIncrementRequest
 *
 * @see V1TransactionsAuthIncrementRequest
 */
class V1TransactionsAuthIncrementRequestBuilder
{
    /**
     * @var V1TransactionsAuthIncrementRequest
     */
    private $instance;

    private function __construct(V1TransactionsAuthIncrementRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions auth increment request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsAuthIncrementRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions auth increment request object.
     */
    public function build(): V1TransactionsAuthIncrementRequest
    {
