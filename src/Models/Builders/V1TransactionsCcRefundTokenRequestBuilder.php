...
/**
 * Builder for model V1TransactionsCcRefundTokenRequest
 *
 * @see V1TransactionsCcRefundTokenRequest
 */
class V1TransactionsCcRefundTokenRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund token request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsCcRefundTokenRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund token request object.
     */
    public function build(): V1TransactionsCcRefundTokenRequest
    {
