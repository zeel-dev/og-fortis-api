...
/**
 * Builder for model Location20
 *
 * @see Location20
 */
class Location20Builder
{
    /**
     * @var Location20
     */
    ...
    private function __construct(Location20 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new location 20 Builder object.
     */
    public static function init(string $phoneNumber): self
    {
        return new self(new Location20($phoneNumber));
    }
    ...
    /**
     * Initializes a new location 20 object.
     */
    public function build(): Location20
    {
