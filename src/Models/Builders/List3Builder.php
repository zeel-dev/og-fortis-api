...
use FortisAPILib\Models\List3;

/**
 * Builder for model List3
 *
 * @see List3
 */
class List3Builder
{
    ...
    private function __construct(List3 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new list 3 Builder object.
     */
    public static function init(): self
    {
        return new self(new List3());
    }
    ...
    /**
     * Initializes a new list 3 object.
     */
    public function build(): List3
    {
