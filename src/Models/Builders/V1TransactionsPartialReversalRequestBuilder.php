...
/**
 * Builder for model V1TransactionsPartialReversalRequest
 *
 * @see V1TransactionsPartialReversalRequest
 */
class V1TransactionsPartialReversalRequestBuilder
{
    /**
     * @var V1TransactionsPartialReversalRequest
     */
    private $instance;

    private function __construct(V1TransactionsPartialReversalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions partial reversal request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsPartialReversalRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions partial reversal request object.
     */
    public function build(): V1TransactionsPartialReversalRequest
    {
