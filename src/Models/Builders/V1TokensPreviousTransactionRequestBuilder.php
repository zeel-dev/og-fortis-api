...
/**
 * Builder for model V1TokensPreviousTransactionRequest
 *
 * @see V1TokensPreviousTransactionRequest
 */
class V1TokensPreviousTransactionRequestBuilder
{
    /**
     * @var V1TokensPreviousTransactionRequest
     */
    private $instance;

    private function __construct(V1TokensPreviousTransactionRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 tokens previous transaction request Builder object.
     */
    public static function init(string $locationId, string $previousTransactionId): self
    {
        return new self(new V1TokensPreviousTransactionRequest($locationId, $previousTransactionId));
    }
    ...
    /**
     * Initializes a new v1 tokens previous transaction request object.
     */
    public function build(): V1TokensPreviousTransactionRequest
    {
