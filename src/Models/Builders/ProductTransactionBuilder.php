...
/**
 * Builder for model ProductTransaction
 *
 * @see ProductTransaction
 */
class ProductTransactionBuilder
{
    /**
    ...
    private function __construct(ProductTransaction $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new product transaction Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductTransaction());
    }
    ...
    /**
     * Initializes a new product transaction object.
     */
    public function build(): ProductTransaction
    {
