...
/**
 * Builder for model V1TransactionsCcBalanceInquiryTicketRequest
 *
 * @see V1TransactionsCcBalanceInquiryTicketRequest
 */
class V1TransactionsCcBalanceInquiryTicketRequestBuilder
{
    /**
     * @var V1TransactionsCcBalanceInquiryTicketRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcBalanceInquiryTicketRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc balance inquiry ticket request Builder object.
     */
    public static function init(string $ticketId): self
    {
        return new self(new V1TransactionsCcBalanceInquiryTicketRequest($ticketId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc balance inquiry ticket request object.
     */
    public function build(): V1TransactionsCcBalanceInquiryTicketRequest
    {
