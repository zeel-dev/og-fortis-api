...
/**
 * Builder for model V1TransactionsCcForceWalletRequest
 *
 * @see V1TransactionsCcForceWalletRequest
 */
class V1TransactionsCcForceWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcForceWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcForceWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc force wallet request Builder object.
     */
    public static function init(string $walletData, string $walletProvider, string $authCode): self
    {
        return new self(new V1TransactionsCcForceWalletRequest($walletData, $walletProvider, $authCode));
    }
    ...
    /**
     * Initializes a new v1 transactions cc force wallet request object.
     */
    public function build(): V1TransactionsCcForceWalletRequest
    {
