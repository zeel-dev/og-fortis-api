...
/**
 * Builder for model Recurring3
 *
 * @see Recurring3
 */
class Recurring3Builder
{
    /**
     * @var Recurring3
     */
    ...
    private function __construct(Recurring3 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new recurring 3 Builder object.
     */
    public static function init(): self
    {
        return new self(new Recurring3());
    }
    ...
    /**
     * Initializes a new recurring 3 object.
     */
    public function build(): Recurring3
    {
