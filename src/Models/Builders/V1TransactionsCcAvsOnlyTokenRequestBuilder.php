...
/**
 * Builder for model V1TransactionsCcAvsOnlyTokenRequest
 *
 * @see V1TransactionsCcAvsOnlyTokenRequest
 */
class V1TransactionsCcAvsOnlyTokenRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only token request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcAvsOnlyTokenRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only token request object.
     */
    public function build(): V1TransactionsCcAvsOnlyTokenRequest
    {
