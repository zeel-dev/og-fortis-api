...
/**
 * Builder for model V1TransactionsCcForceTokenRequest
 *
 * @see V1TransactionsCcForceTokenRequest
 */
class V1TransactionsCcForceTokenRequestBuilder
{
    /**
     * @var V1TransactionsCcForceTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcForceTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc force token request Builder object.
     */
    public static function init(string $authCode): self
    {
        return new self(new V1TransactionsCcForceTokenRequest($authCode));
    }
    ...
    /**
     * Initializes a new v1 transactions cc force token request object.
     */
    public function build(): V1TransactionsCcForceTokenRequest
    {
