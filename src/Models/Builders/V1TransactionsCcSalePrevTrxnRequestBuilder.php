...
/**
 * Builder for model V1TransactionsCcSalePrevTrxnRequest
 *
 * @see V1TransactionsCcSalePrevTrxnRequest
 */
class V1TransactionsCcSalePrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsCcSalePrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSalePrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale prev trxn request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcSalePrevTrxnRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale prev trxn request object.
     */
    public function build(): V1TransactionsCcSalePrevTrxnRequest
    {
