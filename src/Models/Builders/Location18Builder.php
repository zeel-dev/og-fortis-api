...
/**
 * Builder for model Location18
 *
 * @see Location18
 */
class Location18Builder
{
    /**
     * @var Location18
     */
    ...
    private function __construct(Location18 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new location 18 Builder object.
     */
    public static function init(): self
    {
        return new self(new Location18());
    }
    ...
    /**
     * Initializes a new location 18 object.
     */
    public function build(): Location18
    {
