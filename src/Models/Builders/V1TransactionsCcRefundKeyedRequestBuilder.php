...
/**
 * Builder for model V1TransactionsCcRefundKeyedRequest
 *
 * @see V1TransactionsCcRefundKeyedRequest
 */
class V1TransactionsCcRefundKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund keyed request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsCcRefundKeyedRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund keyed request object.
     */
    public function build(): V1TransactionsCcRefundKeyedRequest
    {
