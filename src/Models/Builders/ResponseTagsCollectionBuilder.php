...
/**
 * Builder for model ResponseTagsCollection
 *
 * @see ResponseTagsCollection
 */
class ResponseTagsCollectionBuilder
{
    /**
     * @var ResponseTagsCollection
     */
    private $instance;

    private function __construct(ResponseTagsCollection $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new response tags collection Builder object.
     */
    public static function init(): self
    {
        return new self(new ResponseTagsCollection());
    }
    ...
    /**
     * Initializes a new response tags collection object.
     */
    public function build(): ResponseTagsCollection
    {
