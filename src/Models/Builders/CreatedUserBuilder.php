...
/**
 * Builder for model CreatedUser
 *
 * @see CreatedUser
 */
class CreatedUserBuilder
{
    /**
     * @var CreatedUser
     */
    ...
    private function __construct(CreatedUser $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new created user Builder object.
     */
    public static function init(): self
    {
        return new self(new CreatedUser());
    }
    ...
    /**
     * Initializes a new created user object.
     */
    public function build(): CreatedUser
    {
