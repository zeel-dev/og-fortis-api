...
/**
 * Builder for model V1TransactionsCcSaleTokenRequest
 *
 * @see V1TransactionsCcSaleTokenRequest
 */
class V1TransactionsCcSaleTokenRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale token request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsCcSaleTokenRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale token request object.
     */
    public function build(): V1TransactionsCcSaleTokenRequest
    {
