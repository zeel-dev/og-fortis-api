...
/**
 * Builder for model V1TransactionsRefundRequest
 *
 * @see V1TransactionsRefundRequest
 */
class V1TransactionsRefundRequestBuilder
{
    /**
     * @var V1TransactionsRefundRequest
     */
    private $instance;

    private function __construct(V1TransactionsRefundRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions refund request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsRefundRequest($transactionAmount));
    }
    ...
    /**
     * Initializes a new v1 transactions refund request object.
     */
    public function build(): V1TransactionsRefundRequest
    {
