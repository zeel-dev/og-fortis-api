...
/**
 * Builder for model V1TransactionsCcAuthOnlyWalletRequest
 *
 * @see V1TransactionsCcAuthOnlyWalletRequest
 */
class V1TransactionsCcAuthOnlyWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlyWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlyWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc auth only wallet request Builder object.
     */
    public static function init(int $transactionAmount, string $walletData, string $walletProvider): self
    {
        return new self(
            new V1TransactionsCcAuthOnlyWalletRequest($transactionAmount, $walletData, $walletProvider)
        );
    }
    ...
    /**
     * Initializes a new v1 transactions cc auth only wallet request object.
     */
    public function build(): V1TransactionsCcAuthOnlyWalletRequest
    {
