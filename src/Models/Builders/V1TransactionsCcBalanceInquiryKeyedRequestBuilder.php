...
/**
 * Builder for model V1TransactionsCcBalanceInquiryKeyedRequest
 *
 * @see V1TransactionsCcBalanceInquiryKeyedRequest
 */
class V1TransactionsCcBalanceInquiryKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcBalanceInquiryKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcBalanceInquiryKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc balance inquiry keyed request Builder object.
     */
    public static function init(string $accountNumber, string $expDate): self
    {
        return new self(new V1TransactionsCcBalanceInquiryKeyedRequest($accountNumber, $expDate));
    }
    ...
    /**
     * Initializes a new v1 transactions cc balance inquiry keyed request object.
     */
    public function build(): V1TransactionsCcBalanceInquiryKeyedRequest
    {
