...
/**
 * Builder for model V1TransactionsCcRefundTerminalRequest
 *
 * @see V1TransactionsCcRefundTerminalRequest
 */
class V1TransactionsCcRefundTerminalRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundTerminalRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund terminal request Builder object.
     */
    public static function init(string $locationId, int $transactionAmount, string $terminalId): self
    {
        return new self(new V1TransactionsCcRefundTerminalRequest($locationId, $transactionAmount, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund terminal request object.
     */
    public function build(): V1TransactionsCcRefundTerminalRequest
    {
