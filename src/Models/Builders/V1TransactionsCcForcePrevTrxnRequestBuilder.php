...
/**
 * Builder for model V1TransactionsCcForcePrevTrxnRequest
 *
 * @see V1TransactionsCcForcePrevTrxnRequest
 */
class V1TransactionsCcForcePrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsCcForcePrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcForcePrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc force prev trxn request Builder object.
     */
    public static function init(string $authCode): self
    {
        return new self(new V1TransactionsCcForcePrevTrxnRequest($authCode));
    }
    ...
    /**
     * Initializes a new v1 transactions cc force prev trxn request object.
     */
    public function build(): V1TransactionsCcForcePrevTrxnRequest
    {
