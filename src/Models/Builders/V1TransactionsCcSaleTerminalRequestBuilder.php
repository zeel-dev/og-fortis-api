...
/**
 * Builder for model V1TransactionsCcSaleTerminalRequest
 *
 * @see V1TransactionsCcSaleTerminalRequest
 */
class V1TransactionsCcSaleTerminalRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleTerminalRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale terminal request Builder object.
     */
    public static function init(string $locationId, int $transactionAmount, string $terminalId): self
    {
        return new self(new V1TransactionsCcSaleTerminalRequest($locationId, $transactionAmount, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale terminal request object.
     */
    public function build(): V1TransactionsCcSaleTerminalRequest
    {
