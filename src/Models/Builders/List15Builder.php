...
class List15Builder
{
    ...
    private function __construct(List15 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new list 15 Builder object.
     */
    public static function init(): self
    {
        return new self(new List15());
    }
    ...
    /**
     * Initializes a new list 15 object.
     */
    public function build(): List15
    {
