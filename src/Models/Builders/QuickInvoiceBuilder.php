...
/**
 * Builder for model QuickInvoice
 *
 * @see QuickInvoice
 */
class QuickInvoiceBuilder
{
    /**
     * @var QuickInvoice
     */
    ...
    private function __construct(QuickInvoice $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new quick invoice Builder object.
     */
    public static function init(): self
    {
        return new self(new QuickInvoice());
    }
    ...
    /**
     * Initializes a new quick invoice object.
     */
    public function build(): QuickInvoice
    {
