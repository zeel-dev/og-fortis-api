...
/**
 * Builder for model V1TransactionsCcAuthOnlyKeyedRequest
 *
 * @see V1TransactionsCcAuthOnlyKeyedRequest
 */
class V1TransactionsCcAuthOnlyKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlyKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlyKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc auth only keyed request Builder object.
     */
    public static function init(int $transactionAmount, string $accountNumber, string $expDate): self
    {
        return new self(new V1TransactionsCcAuthOnlyKeyedRequest($transactionAmount, $accountNumber, $expDate));
    }
    ...
    /**
     * Initializes a new v1 transactions cc auth only keyed request object.
     */
    public function build(): V1TransactionsCcAuthOnlyKeyedRequest
    {
