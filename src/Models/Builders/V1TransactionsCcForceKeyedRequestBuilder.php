...
/**
 * Builder for model V1TransactionsCcForceKeyedRequest
 *
 * @see V1TransactionsCcForceKeyedRequest
 */
class V1TransactionsCcForceKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcForceKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcForceKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc force keyed request Builder object.
     */
    public static function init(string $accountNumber, string $expDate, string $authCode): self
    {
        return new self(new V1TransactionsCcForceKeyedRequest($accountNumber, $expDate, $authCode));
    }
    ...
    /**
     * Initializes a new v1 transactions cc force keyed request object.
     */
    public function build(): V1TransactionsCcForceKeyedRequest
    {
