...
/**
 * Builder for model V1TransactionsAuthCompleteRequest
 *
 * @see V1TransactionsAuthCompleteRequest
 */
class V1TransactionsAuthCompleteRequestBuilder
{
    /**
     * @var V1TransactionsAuthCompleteRequest
     */
    private $instance;

    private function __construct(V1TransactionsAuthCompleteRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions auth complete request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsAuthCompleteRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions auth complete request object.
     */
    public function build(): V1TransactionsAuthCompleteRequest
    {
