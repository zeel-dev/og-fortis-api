...
/**
 * Builder for model V1TransactionsCcAuthOnlyTicketRequest
 *
 * @see V1TransactionsCcAuthOnlyTicketRequest
 */
class V1TransactionsCcAuthOnlyTicketRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlyTicketRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlyTicketRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc auth only ticket request Builder object.
     */
    public static function init(int $transactionAmount, string $ticketId): self
    {
        return new self(new V1TransactionsCcAuthOnlyTicketRequest($transactionAmount, $ticketId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc auth only ticket request object.
     */
    public function build(): V1TransactionsCcAuthOnlyTicketRequest
    {
