...
class List10Builder
{
    ...
    private function __construct(List10 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new list 10 Builder object.
     */
    public static function init(): self
    {
        return new self(new List10());
    }
    ...
    /**
     * Initializes a new list 10 object.
     */
    public function build(): List10
    {
