...
/**
 * Builder for model V1TransactionsCcAuthOnlyTerminalRequest
 *
 * @see V1TransactionsCcAuthOnlyTerminalRequest
 */
class V1TransactionsCcAuthOnlyTerminalRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlyTerminalRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlyTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc auth only terminal request Builder object.
     */
    public static function init(string $locationId, int $transactionAmount, string $terminalId): self
    {
        return new self(new V1TransactionsCcAuthOnlyTerminalRequest($locationId, $transactionAmount, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc auth only terminal request object.
     */
    public function build(): V1TransactionsCcAuthOnlyTerminalRequest
    {
