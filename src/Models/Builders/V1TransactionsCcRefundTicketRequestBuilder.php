...
/**
 * Builder for model V1TransactionsCcRefundTicketRequest
 *
 * @see V1TransactionsCcRefundTicketRequest
 */
class V1TransactionsCcRefundTicketRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundTicketRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundTicketRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund ticket request Builder object.
     */
    public static function init(int $transactionAmount, string $ticketId): self
    {
        return new self(new V1TransactionsCcRefundTicketRequest($transactionAmount, $ticketId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund ticket request object.
     */
    public function build(): V1TransactionsCcRefundTicketRequest
    {
