...
/**
 * Builder for model PrimaryLocation
 *
 * @see PrimaryLocation
 */
class PrimaryLocationBuilder
{
    ...
    private function __construct(PrimaryLocation $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new primary location Builder object.
     */
    public static function init(): self
    {
        return new self(new PrimaryLocation());
    }
    ...
    /**
     * Initializes a new primary location object.
     */
    public function build(): PrimaryLocation
    {
