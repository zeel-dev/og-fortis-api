...
/**
 * Builder for model V1TransactionsCcBalanceInquiryTokenRequest
 *
 * @see V1TransactionsCcBalanceInquiryTokenRequest
 */
class V1TransactionsCcBalanceInquiryTokenRequestBuilder
{
    /**
     * @var V1TransactionsCcBalanceInquiryTokenRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcBalanceInquiryTokenRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc balance inquiry token request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcBalanceInquiryTokenRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc balance inquiry token request object.
     */
    public function build(): V1TransactionsCcBalanceInquiryTokenRequest
    {
