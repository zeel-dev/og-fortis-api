...
/**
 * Builder for model V1UsersRequest
 *
 * @see V1UsersRequest
 */
class V1UsersRequestBuilder
{
    /**
     * @var V1UsersRequest
     */
    ...
    private function __construct(V1UsersRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 users request Builder object.
     */
    public static function init(
        ...
        return new self(new V1UsersRequest($email, $lastName, $primaryLocationId, $username, $userTypeCode));
    }
    ...
    /**
     * Initializes a new v1 users request object.
     */
    public function build(): V1UsersRequest
    {
