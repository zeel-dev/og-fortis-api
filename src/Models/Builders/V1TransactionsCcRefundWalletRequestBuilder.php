...
/**
 * Builder for model V1TransactionsCcRefundWalletRequest
 *
 * @see V1TransactionsCcRefundWalletRequest
 */
class V1TransactionsCcRefundWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcRefundWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcRefundWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc refund wallet request Builder object.
     */
    public static function init(int $transactionAmount, string $walletData, string $walletProvider): self
    {
        return new self(new V1TransactionsCcRefundWalletRequest($transactionAmount, $walletData, $walletProvider));
    }
    ...
    /**
     * Initializes a new v1 transactions cc refund wallet request object.
     */
    public function build(): V1TransactionsCcRefundWalletRequest
    {
