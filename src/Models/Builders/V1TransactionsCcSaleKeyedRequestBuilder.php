...
/**
 * Builder for model V1TransactionsCcSaleKeyedRequest
 *
 * @see V1TransactionsCcSaleKeyedRequest
 */
class V1TransactionsCcSaleKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale keyed request Builder object.
     */
    public static function init(int $transactionAmount, string $accountNumber, string $expDate): self
    {
        return new self(new V1TransactionsCcSaleKeyedRequest($transactionAmount, $accountNumber, $expDate));
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale keyed request object.
     */
    public function build(): V1TransactionsCcSaleKeyedRequest
    {
