...
/**
 * Builder for model V1TransactionsCcAvsOnlyWalletRequest
 *
 * @see V1TransactionsCcAvsOnlyWalletRequest
 */
class V1TransactionsCcAvsOnlyWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only wallet request Builder object.
     */
    public static function init(string $walletData, string $walletProvider): self
    {
        return new self(new V1TransactionsCcAvsOnlyWalletRequest($walletData, $walletProvider));
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only wallet request object.
     */
    public function build(): V1TransactionsCcAvsOnlyWalletRequest
    {
