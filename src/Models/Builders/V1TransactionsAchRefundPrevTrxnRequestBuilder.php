...
/**
 * Builder for model V1TransactionsAchRefundPrevTrxnRequest
 *
 * @see V1TransactionsAchRefundPrevTrxnRequest
 */
class V1TransactionsAchRefundPrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsAchRefundPrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsAchRefundPrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions ach refund prev trxn request Builder object.
     */
    public static function init(int $transactionAmount): self
    {
        return new self(new V1TransactionsAchRefundPrevTrxnRequest($transactionAmount));
    }
     ...
     */
    public function identityVerification(?IdentityVerification18 $value): self
    {
     ...
     * Sets joi field.
     */
    public function joi(?Joi24 $value): self
    {
    ...
    /**
     * Initializes a new v1 transactions ach refund prev trxn request object.
     */
    public function build(): V1TransactionsAchRefundPrevTrxnRequest
    {
