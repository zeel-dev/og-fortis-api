...
class MarketplaceBuilder
{
    ...
    private function __construct(Marketplace $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new marketplace Builder object.
     */
    public static function init(): self
    {
        return new self(new Marketplace());
    }
    ...
    /**
     * Initializes a new marketplace object.
     */
    public function build(): Marketplace
    {
