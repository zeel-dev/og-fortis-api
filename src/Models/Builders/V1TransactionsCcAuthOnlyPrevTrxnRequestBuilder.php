...
/**
 * Builder for model V1TransactionsCcAuthOnlyPrevTrxnRequest
 *
 * @see V1TransactionsCcAuthOnlyPrevTrxnRequest
 */
class V1TransactionsCcAuthOnlyPrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsCcAuthOnlyPrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAuthOnlyPrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc auth only prev trxn request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcAuthOnlyPrevTrxnRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc auth only prev trxn request object.
     */
    public function build(): V1TransactionsCcAuthOnlyPrevTrxnRequest
    {
