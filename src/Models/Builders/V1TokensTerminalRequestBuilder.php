...
/**
 * Builder for model V1TokensTerminalRequest
 *
 * @see V1TokensTerminalRequest
 */
class V1TokensTerminalRequestBuilder
{
    /**
     * @var V1TokensTerminalRequest
     */
    private $instance;

    private function __construct(V1TokensTerminalRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 tokens terminal request Builder object.
     */
    public static function init(string $locationId, string $terminalId): self
    {
        return new self(new V1TokensTerminalRequest($locationId, $terminalId));
    }
    ...
    /**
     * Initializes a new v1 tokens terminal request object.
     */
    public function build(): V1TokensTerminalRequest
    {
