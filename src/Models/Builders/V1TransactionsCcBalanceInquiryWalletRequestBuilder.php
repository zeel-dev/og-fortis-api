...
/**
 * Builder for model V1TransactionsCcBalanceInquiryWalletRequest
 *
 * @see V1TransactionsCcBalanceInquiryWalletRequest
 */
class V1TransactionsCcBalanceInquiryWalletRequestBuilder
{
    /**
     * @var V1TransactionsCcBalanceInquiryWalletRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcBalanceInquiryWalletRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc balance inquiry wallet request Builder object.
     */
    public static function init(string $walletData, string $walletProvider): self
    {
        return new self(new V1TransactionsCcBalanceInquiryWalletRequest($walletData, $walletProvider));
    }
    ...
    /**
     * Sets wallet key id field.
     */
    public function walletKeyId(?string $value): self
    {
        $this->instance->setWalletKeyId($value);
        return $this;
    }

    /**
     * Unsets wallet key id field.
     */
    public function unsetWalletKeyId(): self
    {
        $this->instance->unsetWalletKeyId();
        return $this;
    }
    ...
    /**
     * Initializes a new v1 transactions cc balance inquiry wallet request object.
     */
    public function build(): V1TransactionsCcBalanceInquiryWalletRequest
    {
