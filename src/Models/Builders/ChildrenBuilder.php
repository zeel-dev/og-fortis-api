...
class ChildrenBuilder
{
    ...
    private function __construct(Children $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new children Builder object.
     */
    public static function init(): self
    {
        return new self(new Children());
    }
    ...
    /**
     * Initializes a new children object.
     */
    public function build(): Children
    {
