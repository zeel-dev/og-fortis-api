...
/**
 * Builder for model V1TransactionsCcAvsOnlyKeyedRequest
 *
 * @see V1TransactionsCcAvsOnlyKeyedRequest
 */
class V1TransactionsCcAvsOnlyKeyedRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyKeyedRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyKeyedRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only keyed request Builder object.
     */
    public static function init(string $accountNumber, string $expDate): self
    {
        return new self(new V1TransactionsCcAvsOnlyKeyedRequest($accountNumber, $expDate));
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only keyed request object.
     */
    public function build(): V1TransactionsCcAvsOnlyKeyedRequest
    {
