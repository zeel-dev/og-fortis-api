...
/**
 * Builder for model V1TransactionsCcAvsOnlyPrevTrxnRequest
 *
 * @see V1TransactionsCcAvsOnlyPrevTrxnRequest
 */
class V1TransactionsCcAvsOnlyPrevTrxnRequestBuilder
{
    /**
     * @var V1TransactionsCcAvsOnlyPrevTrxnRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcAvsOnlyPrevTrxnRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc avs only prev trxn request Builder object.
     */
    public static function init(): self
    {
        return new self(new V1TransactionsCcAvsOnlyPrevTrxnRequest());
    }
    ...
    /**
     * Initializes a new v1 transactions cc avs only prev trxn request object.
     */
    public function build(): V1TransactionsCcAvsOnlyPrevTrxnRequest
    {
