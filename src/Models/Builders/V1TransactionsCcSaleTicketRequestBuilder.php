...
/**
 * Builder for model V1TransactionsCcSaleTicketRequest
 *
 * @see V1TransactionsCcSaleTicketRequest
 */
class V1TransactionsCcSaleTicketRequestBuilder
{
    /**
     * @var V1TransactionsCcSaleTicketRequest
     */
    private $instance;

    private function __construct(V1TransactionsCcSaleTicketRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new v1 transactions cc sale ticket request Builder object.
     */
    public static function init(int $transactionAmount, string $ticketId): self
    {
        return new self(new V1TransactionsCcSaleTicketRequest($transactionAmount, $ticketId));
    }
    ...
    /**
     * Initializes a new v1 transactions cc sale ticket request object.
     */
    public function build(): V1TransactionsCcSaleTicketRequest
    {
