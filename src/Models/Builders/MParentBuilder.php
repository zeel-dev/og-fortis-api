...
/**
 * Builder for model MParent
 *
 * @see MParent
 */
class MParentBuilder
{
    /**
     * @var MParent
     */
    ...
    private function __construct(MParent $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new mparent Builder object.
     */
    public static function init(): self
    {
        return new self(new MParent());
    }
    ...
    /**
     * Initializes a new mparent object.
     */
    public function build(): MParent
    {
