...
/**
 * Builder for model ProductTransaction1
 *
 * @see ProductTransaction1
 */
class ProductTransaction1Builder
{
    /**
     * @var ProductTransaction1
     */
    private $instance;

    private function __construct(ProductTransaction1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new product transaction 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new ProductTransaction1());
    }
     ...
     */
    public function batchRiskConfig(?array $value): self
    {
    ...
    /**
     * Initializes a new product transaction 1 object.
     */
    public function build(): ProductTransaction1
    {
