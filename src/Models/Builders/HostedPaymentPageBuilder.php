...
class HostedPaymentPageBuilder
{
    ...
    {
        return new self(new HostedPaymentPage());
    }
    ...
    /**
     * Sets field configuration field.
     */
    public function fieldConfiguration(?FieldConfiguration $value): self
    {
        $this->instance->setFieldConfiguration($value);
        return $this;
    }
