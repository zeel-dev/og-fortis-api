...
class V1TransactionsCcForceWalletRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(string $walletData, string $walletProvider, string $authCode)
    {
