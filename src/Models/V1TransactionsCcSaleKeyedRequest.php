...
class V1TransactionsCcSaleKeyedRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(int $transactionAmount, string $accountNumber, string $expDate)
    {
