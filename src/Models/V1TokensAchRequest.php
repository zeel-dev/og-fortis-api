...
class V1TokensAchRequest implements \JsonSerializable
{
    /**
     * @var array
     */
     ...
     *
     * @maps account_type
     * @factory \FortisAPILib\Models\AccountType7Enum::checkValue
     */
    ...
    /**
     * Returns Is Company.
     * This identifies whether the ACH account belongs to a company or individual. This can affect which
     * SEC code is used when attempting to run a transaction.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->accountType)) {
            $json['account_type']                  = AccountType7Enum::checkValue($this->accountType['value']);
        }
        if (isset($this->isCompany)) {
            $json['is_company']                    = $this->isCompany;
        }
