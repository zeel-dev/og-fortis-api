...
class V1TransactionsCcAuthOnlyWalletRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(int $transactionAmount, string $walletData, string $walletProvider)
    {
    ...
    /**
     * Returns Secure Ecomm Url.
     * (ECOMM) This field is used to enter a merchant identifier such as the Merchant URL or reverse domain
     * name as presented to the consumer during the checkout process for a Digital Secure Remote payment
     * transaction
     */
    public function getSecureEcommUrl(): ?string
    {
        if (count($this->secureEcommUrl) == 0) {
            return null;
        }
        return $this->secureEcommUrl['value'];
    }

    /**
     * Sets Secure Ecomm Url.
     * (ECOMM) This field is used to enter a merchant identifier such as the Merchant URL or reverse domain
     * name as presented to the consumer during the checkout process for a Digital Secure Remote payment
     * transaction
     *
     * @maps secure_ecomm_url
     */
    public function setSecureEcommUrl(?string $secureEcommUrl): void
    {
        $this->secureEcommUrl['value'] = $secureEcommUrl;
    }

    /**
     * Unsets Secure Ecomm Url.
     * (ECOMM) This field is used to enter a merchant identifier such as the Merchant URL or reverse domain
     * name as presented to the consumer during the checkout process for a Digital Secure Remote payment
     * transaction
     */
    public function unsetSecureEcommUrl(): void
    {
        $this->secureEcommUrl = [];
    }
     ...
     *
     * @maps wallet_type
     * @factory \FortisAPILib\Models\WalletTypeEnum::checkValue
     */
     ...
     * @maps wallet_data
     */
    public function setWalletData(string $walletData): void
    {
        $this->walletData = $walletData;
    }
     ...
     *
     * @required
     * @maps wallet_provider
     * @factory \FortisAPILib\Models\WalletProviderEnum::checkValue
     */
    public function setWalletProvider(string $walletProvider): void
    {
        $this->walletProvider = $walletProvider;
    }

    /**
     * Returns Wallet Key Id.
     * Wallet Key ID
     */
    public function getWalletKeyId(): ?string
    {
        if (count($this->walletKeyId) == 0) {
            return null;
        }
        return $this->walletKeyId['value'];
    }
     ...
     * @maps wallet_key_id
     */
    public function setWalletKeyId(?string $walletKeyId): void
    {
        $this->walletKeyId['value'] = $walletKeyId;
    }

    /**
     * Unsets Wallet Key Id.
     * Wallet Key ID
     */
    public function unsetWalletKeyId(): void
    {
        $this->walletKeyId = [];
    }
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->secureEcommUrl)) {
            $json['secure_ecomm_url']                       = $this->secureEcommUrl['value'];
        }
        ...
        $json['wallet_data']                                = $this->walletData;
        $json['wallet_provider']                            = WalletProviderEnum::checkValue($this->walletProvider);
        if (!empty($this->walletKeyId)) {
            $json['wallet_key_id']                          = $this->walletKeyId['value'];
        }
