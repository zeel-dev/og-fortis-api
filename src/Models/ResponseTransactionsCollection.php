...
class ResponseTransactionsCollection implements \JsonSerializable
{
     ...
     * @var string|null
     */
    private $type = Type98Enum::TRANSACTIONSCOLLECTION;
     ...
     *
     * @maps type
     * @factory \FortisAPILib\Models\Type98Enum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        $json = [];
        if (isset($this->type)) {
            $json['type']       = Type98Enum::checkValue($this->type);
        }
        if (isset($this->list)) {
            $json['list']       = $this->list;
        }
