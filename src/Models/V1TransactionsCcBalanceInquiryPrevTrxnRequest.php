...
class V1TransactionsCcBalanceInquiryPrevTrxnRequest implements \JsonSerializable
{
    /**
     ...
     * @var array
     */
    private $previousTransactionApiId = [];
    ...
    /**
     * Returns Previous Transaction Api Id.
     ...
     */
    public function getPreviousTransactionApiId(): ?string
    {
        if (count($this->previousTransactionApiId) == 0) {
            return null;
        }
        return $this->previousTransactionApiId['value'];
    }

    /**
     * Sets Previous Transaction Api Id.
     * previous_transaction_api_id is used as token to run transaction. Account details OR
     * previous_transaction_api_id should be passed to run transaction.
     *
     * @maps previous_transaction_api_id
     */
    public function setPreviousTransactionApiId(?string $previousTransactionApiId): void
    {
        $this->previousTransactionApiId['value'] = $previousTransactionApiId;
    }

    /**
     * Unsets Previous Transaction Api Id.
     * previous_transaction_api_id is used as token to run transaction. Account details OR
     * previous_transaction_api_id should be passed to run transaction.
     */
    public function unsetPreviousTransactionApiId(): void
    {
        $this->previousTransactionApiId = [];
    }

    /**
     * Returns Joi.
     */
    public function getJoi(): ?Joi24
    {
        return $this->joi;
    }
     ...
     * @maps _joi
     */
    public function setJoi(?Joi24 $joi): void
    {
        $this->joi = $joi;
    }
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->previousTransactionApiId)) {
            $json['previous_transaction_api_id']            = $this->previousTransactionApiId['value'];
        }
        if (isset($this->joi)) {
            $json['_joi']                                   = $this->joi;
        }
