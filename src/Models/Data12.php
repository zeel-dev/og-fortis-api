...
class Data12 implements \JsonSerializable
{
     ...
     * The Location.
     */
    public function getLocation(): ?Location5
    {
     ...
     * @maps location
     */
    public function setLocation(?Location5 $location): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->primaryPrincipal)) {
