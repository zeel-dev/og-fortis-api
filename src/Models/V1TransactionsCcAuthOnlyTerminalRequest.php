...
class V1TransactionsCcAuthOnlyTerminalRequest implements \JsonSerializable
{
    /**
     ...
     */
    public function __construct(string $locationId, int $transactionAmount, string $terminalId)
    {
     ...
     *
     * @maps e_format
     * @factory \FortisAPILib\Models\EFormatEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->eFormat)) {
            $json['e_format']                               = EFormatEnum::checkValue($this->eFormat['value']);
        }
